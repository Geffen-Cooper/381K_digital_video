...
class ArtifactReduction(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv3d(in_channels=3, out_channels=4, kernel_size=3, padding=1)
        ...
        self.conv2 = nn.Conv3d(in_channels=4, out_channels=8, kernel_size=3, padding=1) 
        ...
        self.conv3 = nn.Conv3d(in_channels=8, out_channels=3, kernel_size=(7,3,3), padding=1)
